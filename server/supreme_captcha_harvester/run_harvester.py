...
from supreme_captcha_harvester.utils import n_logging, c_logging
...
def submit():
    ...
    expiry = datetime.now().timestamp() + 1200
    tokenDict = {
        'token': token,
        'expiry': expiry
    }
...
def main():
    ...
    with open('server/supreme_captcha_harvester/config.json') as file:
        global config
